...
2. Open your web browser and navigate to `http://localhost:8000/chatbot/register` to create a new user account. 
...
Happy chatting with Athena ChatGPT! 🤖💬
